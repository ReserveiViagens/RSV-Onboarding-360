...
exports.up = function(knex) {
  return knex.schema.createTable('bookings', function(table) {
    ...
    table.enum('type', ['hotel', 'flight', 'car', 'tour', 'package', 'activity']).notNullable();
    table.enum('status', ['pending', 'confirmed', 'in_progress', 'completed', 'cancelled', 'refunded']).defaultTo('pending');
