...
exports.up = function(knex) {
  return knex.schema.createTable('payments', function(table) {
    ...
    table.enum('type', ['payment', 'refund', 'fee', 'discount', 'adjustment']).defaultTo('payment');
    table.enum('method', ['credit_card', 'debit_card', 'bank_transfer', 'pix', 'cash', 'voucher']).notNullable();
