...
export default function Dashboard() {
    ...
    const categories: Category[] = [
        ...
        },
        {
            ...
            color: 'teal',
            services: [
                { name: 'Cadastros', port: 5025, status: 'online', icon: '📋', description: 'Gestão de corretores e proprietários' },
                { name: 'Usuários', port: 5026, status: 'online', icon: '👤', description: 'Gestão de usuários do sistema' },
                { name: 'Permissões', port: 5027, status: 'online', icon: '🔐', description: 'Controle de acesso e permissões' }
            ]
        }
    ];
